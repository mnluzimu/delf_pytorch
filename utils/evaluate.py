...
def compute_map_and_print(dataset, ranks, gnd, kappas=[1, 5, 10], f=None):
    ...
    # new evaluation protocol
        ...
        if f is not None:
            f.write('>> {}: mAP E: {}, M: {}, H: {}\n'.format(dataset, np.around(mapE * 100, decimals=2),
                                                      np.around(mapM * 100, decimals=2),
                                                      np.around(mapH * 100, decimals=2)))
            f.write('>> {}: mP@k{} E: {}, M: {}, H: {}\n'.format(dataset, kappas, np.around(mprE * 100, decimals=2),
                                                         np.around(mprM * 100, decimals=2),
                                                         np.around(mprH * 100, decimals=2)))